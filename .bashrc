...
#My neovim install from apt was not working, so i had to install nvim from source
...
# Command to run xrandr script that sets up my monitors
alias scr='/bin/bash $HOME/.screenlayout/two_monitors.sh'
